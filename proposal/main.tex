...
%They start appearing for real-time audio DSP applications (i.e., Antelope Audio,\footnote{\url{https://en.antelopeaudio.com}} Korora Audio,\footnote{\url{https://www.kororaaudio.com}} etc.).
...
In this context, the FAST project was thought to overcome the aforementioned difficulties (i.e. low latency, computing capacity, ease of programming) and offer to the many the opportunity of easily implement into the real world their creations.}
